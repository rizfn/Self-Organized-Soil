let { default: data_meanfield } = await import("../data/nutrient_starvation/meanfield_rho=1_delta=0.json", { assert: { type: "json" } });
let { default: data_rho_05 } = await import("../data/nutrient_starvation/meanfield_rho=0.5_delta=0.json", { assert: { type: "json" } });
let { default: data_delta_05 } = await import("../data/nutrient_starvation/meanfield_rho=1_delta=0.5.json", { assert: { type: "json" } });
