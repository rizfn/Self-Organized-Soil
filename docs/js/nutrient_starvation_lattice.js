const { default: data } = await import("../data/nutrient_starvation/lattice_rho=1_delta=0.json", { assert: { type: "json" } });
// const { default: data } = await import("../data/nutrient_starvation/lattice_rho=0.5_delta=0.json", { assert: { type: "json" } });
// const { default: data } = await import("../data/nutrient_starvation/lattice_rho=1_delta=0.5.json", { assert: { type: "json" } });
...
var Tooltip = d3.select("div#raster")
	...
	Tooltip
		.html("d=" + d3.format("0.2f")(d.theta) + ", " + "s=" + d3.format("0.2f")(d.sigma) + "<br>" + d3.format("0.4f")(d.soil_boundaries))
