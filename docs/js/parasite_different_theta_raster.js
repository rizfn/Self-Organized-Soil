...
datasets.forEach((data, index) => {
    data.sort((a, b) => {
        if (a.sigma === b.sigma) {
            // If sigma is equal, sort by theta1
    ...
    var rows = d3.map(data, function(d){return d.theta1;})
    ...
    var mousemove_rgb = function(event, d) {
        ...
        Tooltip
            .html("theta1=" + d3.format("0.2f")(d.theta1) + ", " + "sigma=" + d3.format("0.2f")(d.sigma) + "<br>" + d3.format("0.2")(d.soil) + ", " + d3.format("0.2")(d.vacancy) + ", " + d3.format("0.2")(d.nutrient) + ", " + d3.format("0.2")(d.green) + ", " + d3.format("0.2")(d.blue))
    ...
    svg.selectAll(".cell")
        ...
        .append("rect")
        .attr("class", "cell")
        .attr("x", function(d) { return x(d.theta1) })
