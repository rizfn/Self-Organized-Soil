...
// const data_prefix = `../data/twospec_samenutrient/lattice3D_L=50_rho1=0.25_mu1=1_rho2=0.5_mu2=0/`
const data_prefix = `../data/twospec_samenutrient/lattice3D_L=50_rho1=0.25_mu1=1_rho2=1_mu2=0/`
...
var mousemove = function (event, d) {
    ...
    Tooltip
        .html("d=" + d3.format("0.2f")(d.theta) + ", " + "s=" + d3.format("0.2f")(d.sigma) + "<br>" + d3.format("0.2")(d.soil) + ", " + d3.format("0.2")(d.vacancy) + ", " + d3.format("0.2")(d.nutrient) + ", " + d3.format("0.2")(d.green) + ", " + d3.format("0.2")(d.blue))
