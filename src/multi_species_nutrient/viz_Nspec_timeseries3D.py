...
def viz_L_100():
    ...
    data = pd.read_csv(f"src/multi_species_nutrient/outputs/timeseries3D/Nspec_L_100/{N}spec_sigma_{sigma}_theta_{theta}.csv")
    ...
    plt.savefig(f'src/multi_species_nutrient/plots/timeseries3D/Nspec_L_100/{N}spec_sigma_{sigma}_theta_{theta}.png', dpi=300)
