...
import pandas as pd
from two_species_soil_neighbour_utils import run_stochastic, run_stochastic_wellmixed
...
def main():
    ...
    soil_lattice_data.to_json(f"docs/data/two_species/soil_neighbours_{r=}.json", orient="records")
