...
from single_species_utils import init_lattice, update_stochastic
...
def main():
    ...
    ani.save("src/single_species_RW/stochastic_dynamics_logspace.gif", fps=1)
    ...
    # ax.legend()
    # save figure
    # fig.savefig("src/single_species_RW/stochastic_dynamics_time_ev.png", dpi=300)
