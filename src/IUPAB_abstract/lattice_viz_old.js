...
renderer.setClearColor(0xffffff, 0.1); // the first argument is the color in hexadecimal, the second argument is the opacity
...
var pointLight = new THREE.PointLight(0xffcccc, 1, 0);

// Position the light x units to the right, y units above, and z units behind the camera
var offset = 1;
pointLight.position.set(camera.position.x + offset, camera.position.y, camera.position.z - offset);
